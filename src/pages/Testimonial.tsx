const testimonials = [
  ...
  { name: 'Procurement Lead, Regional Transit Authority', role: 'Transit & Infrastructure', quote: 'Forez helped us consolidate multiple hard-to-source components into one clean procurement cycle. Fast response and reliable fulfillment.' },
  { name: 'Fleet Maintenance Supervisor, Metro Transit Agency', role: 'Transit & Infrastructure', quote: 'We needed certified MBE suppliers for our diversity spend goals. Forez met every compliance requirement and delivered on time — every time.' },
  ...
  { name: 'Director of Supply Chain, Port Authority Contractor', role: 'Transit & Infrastructure', quote: 'Documentation for public contracts can be a headache. Forez came prepared with everything we needed — MBE cert, COCs, packing slips. Seamless.' },
  // Power Generation
  ...
  { name: 'Reliability Engineer, Gas Turbine Facility', role: 'Power Generation', quote: 'We rely on Forez for bearing replacements during planned outages. Their knowledge of OEM equivalents has saved us significant downtime costs.' },
  { name: 'Plant Maintenance Coordinator, Combined-Cycle Plant', role: 'Power Generation', quote: 'Hard-to-find shaft couplings on short notice — Forez sourced them in 72 hours when our regular supplier quoted 6 weeks.' },
  ...
  { name: 'Maintenance Director, Municipal Water Authority', role: 'Wastewater & Utilities', quote: 'We needed a supplier who understands NYC agency procurement. Forez knew exactly what we needed and had the certifications to back it up.' },
  ...
  // HVAC & Facilities
  { name: 'HVAC Contractor, Commercial Property Management', role: 'HVAC & Facilities', quote: 'Fast shipping and the right parts the first time. We switched to Forez after too many delays with our previous supplier.' },
  { name: 'Facilities Manager, Large Healthcare Campus', role: 'HVAC & Facilities', quote: 'Critical equipment means we can not wait. Forez has consistently delivered within tight windows for our facility maintenance team.' },
  ...
  // Manufacturing & MRO
  { name: 'Production Manager, Metal Fabrication Shop', role: 'Manufacturing & MRO', quote: 'We run lean — downtime is not an option. Forez keeps our critical spares stocked and our line running.' },
  ...
  { name: 'Engineering Buyer, Precision Parts Manufacturer', role: 'Manufacturing & MRO', quote: 'We needed exact OEM spec bearings with full certifications. Forez sourced and delivered within two days. Exceptional.' },
  { name: 'Inventory Manager, Distribution Warehouse', role: 'Manufacturing & MRO', quote: 'We consolidated our MRO sourcing to Forez for simplicity. Single point of contact, clean invoicing, reliable delivery.' },
  { name: 'Plant Engineer, Food Processing Facility', role: 'Manufacturing & MRO', quote: 'Forez understands the urgency of food production environments. They have never let us down on a critical call.' },
  // Airport & Baggage Handling
  { name: 'Technical Supervisor, Airport Ground Systems', role: 'Airport & Baggage Handling', quote: 'Baggage system downtime costs airlines thousands per minute. Forez is one of the few suppliers who truly understands that urgency.' },
  ...
  { name: 'Operations Lead, Terminal Facilities Group', role: 'Airport & Baggage Handling', quote: 'Reliable, certified, and fast. Those three words describe every order we have placed with Forez.' },
  // General Positive
  { name: 'Buyer, Industrial Services Company', role: 'Industrial Services', quote: 'I have worked with a lot of distributors. Forez is one of the few that actually follows through on every commitment.' },
  ...
  { name: 'Project Manager, Mechanical Contractor', role: 'Mechanical Contracting', quote: 'We use Forez for multi-site projects. Their ability to coordinate deliveries across locations saves us real time.' },
  ...
  { name: 'Maintenance Supervisor, Chemical Processing Plant', role: 'Chemical Processing', quote: 'Forez sourced specialty couplings with material certifications required for our plant environment. Outstanding service.' },
  { name: 'Regional Facilities Director, Healthcare Network', role: 'Healthcare Facilities', quote: 'Multi-facility orders, tight delivery windows, and regulatory requirements — Forez handles it all without missing a beat.' },
];
...
export default function Testimonial() {
  useSEO({
    ...
    description: 'Read testimonials from transit agencies, power generation facilities, utilities, manufacturers, and government contractors who rely on Forez for industrial procurement.',
    path: '/testimonial',
    keywords: 'Forez reviews, industrial supplier testimonials, MBE supplier feedback, customer reviews industrial distribution',
